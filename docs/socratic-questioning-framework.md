...
> **来源**：https://github.com/Imbad0202/academic-research-skills —— `deep-research/references/socratic_questioning_framework.md`
> commit `462b32bf32a7017ef62c55f7ee262a2642de325a`（README 提及的 v1.2.x 版本）。本文件为**原文备份**（英文），用于溯源与对照；
> **学术galgame 实际采纳的是改编版** [`skills/socratic-questioning/SKILL.md`](../skills/socratic-questioning/SKILL.md)（已按学科学习情境改写并接入鲸鱼娘老师人设）。
